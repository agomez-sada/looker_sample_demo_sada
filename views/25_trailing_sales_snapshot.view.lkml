view: trailing_sales_snapshot {
  derived_table: {
    ...
    sql: with calendar as
      ...
      from bi-eng-internal.ecommerce_sample.inventory_items
      ...
      from bi-eng-internal.ecommerce_sample.order_items
      join bi-eng-internal.ecommerce_sample.inventory_items
