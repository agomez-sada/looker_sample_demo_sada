...
view: user_order_product {
  derived_table: {
    ...
    sql: SELECT
      ...
      FROM bi-eng-internal.ecommerce_sample.order_items oi
      LEFT JOIN bi-eng-internal.ecommerce_sample.inventory_items ii
        ON oi.inventory_item_id = ii.id
      LEFT JOIN bi-eng-internal.ecommerce_sample. products p
...
view: total_order_product {
  derived_table: {
    ...
    sql: SELECT
        ...
        , COUNT(*) AS prod_freq
      FROM bi-eng-internal.ecommerce_sample.order_items oi
      LEFT JOIN bi-eng-internal.ecommerce_sample.inventory_items
